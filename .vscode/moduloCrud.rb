...
module Crud
  ...
  def self.create_hash_digest(password) #outra opcao é usar o self. ou o nome do module: Crud. antes do nome do metodo para permitir que o mesmo seja lido completamente noutro arquivo após ser chamado
  ...
  def Crud.veriy_hash_digest(password)
